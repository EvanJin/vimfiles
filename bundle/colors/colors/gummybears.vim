...
hi  Cursor       guifg=#ffffff guibg=#b0d0f0 gui=NONE      ctermfg=231   ctermbg=24   cterm=reverse
" hi  Cursor       guifg=#000000 guibg=#ffff00 gui=NONE      ctermfg=0     ctermbg=11   cterm=reverse // orginal
