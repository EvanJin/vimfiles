...
hi ErrorMsg     gui=NONE guibg=NONE guifg=Firebrick2
...
hi Cursor       gui=NONE guibg=#35AFED guifg=#000000
...
hi Statement    gui=NONE guifg=#6CAEFF guibg=NONE
hi Todo         gui=NONE guifg=Green4 guibg=DeepSkyBlue1
hi Type         gui=NONE guifg=#8D79F2 guibg=NONE
